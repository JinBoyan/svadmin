...
## [0.2.0](https://github.com/zuohuadong/svadmin/compare/mcp-v0.1.0...mcp-v0.2.0) (2026-03-29)
...
* **mcp:** add @svadmin/mcp package — MCP server exposing DataProvider as tools ([84fc3f6](https://github.com/zuohuadong/svadmin/commit/84fc3f602e5808b9a16e7d4db55c6033f5d6d9ac))
